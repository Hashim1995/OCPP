...
const getDarkMode = () => localStorage.getItem('darkTheme') === 'true';
...
const showCloseConfirmationModal = ({
  ...
  Modal.confirm({
    ...
    className: `confirmModal ${darkTheme ? 'confirmModalDark' : ''}`,
    okButtonProps: { style: { backgroundColor: '#343452' } }
  });
};
